...
<div class="nk-block">
     <div class="row align-items-center">
         ...
         <div class="col-lg-7 col-xl-8 mt-5 mt-lg-4">
               <div class="row g-2">
            @if($package->settings->portfolio == 1)
                           ...
                           <div class="nk-wgw sm">
                               <a class="nk-wgw-inner">
                                   <div class="nk-wgw-name">
                                       ...
                                       <h5 class="nk-wgw-title title">{{ __('Portfolio') }}</h5>
                                   </div>
                                   <div class="nk-wgw-balance">
                                       <div class="amount">{{(!empty($portfolios) ? count($portfolios) : "")}}</div>
                                   </div>
                               </a>
                           </div>
                       </div>
                           ...
                           <div class="nk-wgw sm">
                               <a class="nk-wgw-inner">
                                   <div class="nk-wgw-name">
                                       ...
                                       <h5 class="nk-wgw-title title">{{ __('Links') }}</h5>
                                   </div>
                                   <div class="nk-wgw-balance">
                                       <div class="amount">{{(!empty($links) ? count($links) : "")}}</div>
                                   </div>
                               </a>
                           </div>
                       </div>
