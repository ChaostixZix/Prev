...
<div class="nk-block-head col-md-8 mx-auto mt-7">
    <div class="nk-block-head-content">
        <div class="nk-block-head-sub"><a class="back-to" href="{{ route('home.manage') }}"><em class="icon ni ni-arrow-left"></em><span>{{ __('Dashboard') }}</span></a></div>
...
<div class="nk-block col-md-8 mx-auto">
    <div class="nk-block-title-group mb-3">
        ...
        <form action="{{ route('activities') }}" method="post">
             @csrf
