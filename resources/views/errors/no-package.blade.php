        ...
        <div class="nk-block nk-auth-body wide-md mb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-5">
                             <img src="{{ url('img/bermuda-no-comments.png') }}" alt="{{ env('APP_HOME') }}">
                        </div>
                    </div>
                    <div class="col-md-6 mt-5em">
                        ...
                        <a href="{{ route('plans') }}" class="btn btn-block btn-outline-dark"><em class="icon ni ni-package"></em> <span>{{ __('Check other package') }}</span></a>
                    </div>
                </div>
            </div>
        </div>
