        ...
        <div class="row">
          <div class="col-md-6">
            <div class="data-head mb-4 mt-5">
             ...
             <div class="form-group">
                <div class="form-label-group"><label class="form-label" for="default-01">{{ __('Website URL') }}</label></div>
                <input type="text" class="form-control form-control-lg @error('app_url') is-invalid @enderror" placeholder="{{ __('Enter your Website URL') }}" value="{{ url('/') }}" name="app_url" value="{{ old('APP_URL') }}">
                 @error('app_url')
                     <span class="invalid-feedback d-block m-0" role="alert">
                         <strong>{{ $message }}</strong>
                     </span>
            ...
            <div class="col-md-6">
                <div class="data-head mb-4 mt-5">
                  <h6 class="overline-title"><span>License</span></h6>
                </div>
               <div class="form-group">
                    <input id="license" class="form-control form-control-lg @error('license') is-invalid @enderror" type="text" placeholder="{{ __('License') }}" name="license" value="{{ old('license') }}"/>
                  @error('license')
                      <span class="invalid-feedback d-block m-0" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
