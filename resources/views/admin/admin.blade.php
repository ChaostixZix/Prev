                     ...
                     <div class="col-sm-6 col-xxl-12">
                        <div class="nk-order-ovwg-data bdrs-20 buy">
                           <div class="amount">{{$payments[0]->payment}}
                            <small class="currenct currency-usd">Payments this month</small>
                            </div>
                           <div class="info">{{ __('This month') }}
                            <strong>{{$payments[0]->earnings . $website->currency }}
         ...
         <div class="card-inner">
            <div class="nk-wg-action">
               <div class="nk-wg-action-content">
                  ...
                  <div class="title">{{ __('Support Messages') }}</div>
                  <p>{!! __('You have <strong>'.$sidebarR->countUnreadSupport.'</strong> Unread tickets. You can check them here!') !!}</p>
               </div>
               <a href="{{ route('admin.support') }}" class="btn btn-icon btn-trigger mr-n2"><em class="icon ni ni-forward-ios"></em></a>
            </div>
         </div>
         <div class="card-inner">
            <div class="nk-wg-action">
            ...
            <div class="nk-tb-item">
               <div class="nk-tb-col">
                <div class="user-avatar bg-primary-dim">
                    <img src="{{ General::user_profile($item->id) }}" alt="">
                </div>
               </div>

               <div class="nk-tb-col"><span class="tb-lead">{{ucfirst($item->name)}}</span></div>
                ...
                <div class="user-activity">
                  <div class="user-avatar bg-primary-dim mr-4">
                   ...
                   <div class="info">
                    ...
                    <span class="title">{{$item->name}} <a href="{{url("$item->username")}}" target="_blank" class="btn-link ml-3">View profile</a></span>
                  </div>
                </div>
             </div>
             @endforeach
