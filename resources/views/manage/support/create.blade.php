...
@stop
@section('content')
<div class="container wide-sm mt-8">
         ...
         <div class="nk-content-wrap">
            <div class="nk-block-head nk-block-head-lg wide-sm m-auto text-left">
               <div class="nk-block-head-content card-shadow card card-inner bdrs-20">
                  <h5 class="nk-block-title fw-normal">{{ __('How can we help?') }}</h5>
               </div>
            </div>
            <!-- .nk-block-head -->
            <div class="nk-block mb-3">
               <div class="card card-shadow bdrs-20">
                  <div class="card-inner">
                     <form action="{{ route('post.support') }}" method="post" class="form-contact">
                      @csrf
                        <div class="row g-4">
                           <div class="col-md-6">
                           ...
                           <div class="col-12">
                              <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                    <input type="text" class="form-control form-control-lg" placeholder="Write your problem... " name="problem">
                                 </div>
                              </div>
                           </div>
                           <!-- .col -->
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                    <div class="form-editor-custom">
                                       <textarea class="form-control form-control-lg no-resize editor" placeholder="{{ __('Write your message') }}" name="message"></textarea>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-12">
                              <button type="submit" class="button w-100 primary">{{ __('Submit') }}</button>
                           </div>
                           <!-- .col -->
                        </div>
                        <!-- .row -->
